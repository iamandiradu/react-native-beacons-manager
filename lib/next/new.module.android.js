...
function stopBeaconService(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.stopBeaconService(resolve, reject);
  });
}

function startBeaconService(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.startBeaconService(resolve, reject);
  })
}
