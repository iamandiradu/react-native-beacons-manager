...
function stopBeaconService(toggled?: boolean): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.stopBeaconService(toggled, resolve, reject);
  });
}

function startBeaconService(toggled?: boolean): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.startBeaconService(toggled, resolve, reject);
  })
}
